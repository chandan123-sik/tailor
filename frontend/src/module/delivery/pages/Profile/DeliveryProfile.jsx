    ...
    return (
        <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-700 pb-2">
            ...
            <div className="pt-4 pb-0">
                <button className="w-full bg-rose-50 text-rose-500 py-3 rounded-xl font-black text-sm tracking-widest border border-rose-100 hover:bg-rose-500 hover:text-white transition-all shadow-sm active:scale-95 flex items-center justify-center gap-3 group">
